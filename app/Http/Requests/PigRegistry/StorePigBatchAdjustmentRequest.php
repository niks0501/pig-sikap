...
class StorePigBatchAdjustmentRequest extends FormRequest
{
    ...
    {
        return [
            'adjustment_type' => ['required', 'string', Rule::in(PigBatchAdjustment::ADJUSTMENT_TYPES)],
            'quantity_change' => ['required', 'integer'],
            'quantity_after' => ['nullable', 'integer', 'min:0'],
            'reason' => ['required', 'string', Rule::in(PigBatchAdjustment::REASONS)],
