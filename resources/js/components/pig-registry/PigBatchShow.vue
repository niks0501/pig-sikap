...
<template>
    <div class="mx-auto max-w-300 space-y-4">
        <section class="flex flex-col gap-4 rounded-xl border border-gray-200 bg-white p-4 shadow-sm lg:flex-row lg:items-center lg:justify-between">
            <div>
                <h2 class="text-2xl font-bold text-gray-900">{{ props.cycle.batch_code }}</h2>
            ...
            <div class="flex flex-wrap items-center gap-2">
                ...
                <form v-if="!isArchived" :action="props.routes.archive" method="POST" onsubmit="return confirm('Archive this cycle? Operational editing will be restricted.');">
        ...
        <section class="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            ...
            <article class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
                <p class="text-xs font-semibold uppercase tracking-[0.18em] text-gray-500">Profile Manager</p>
                <a :href="props.routes.profilesIndex" class="mt-2 inline-flex rounded-lg bg-[#0c6d57]/10 px-3 py-2 text-sm font-semibold text-[#0c6d57] transition hover:bg-[#0c6d57]/20">Go to Dedicated Manager</a>
            </article>
            <article class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
                    ...
                    <article class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm sm:p-6">
                        ...
                        <form v-else :action="props.routes.adjustmentsStore" method="POST" class="mt-4 space-y-3">
                            ...
                            <label class="block">
                                ...
                                <textarea name="remarks" rows="2" class="w-full rounded-xl border border-gray-300 px-3 py-2.5 text-sm text-gray-900 focus:border-[#0c6d57] focus:outline-none focus:ring-2 focus:ring-[#0c6d57]/20" />
                            </label>
