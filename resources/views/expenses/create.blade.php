<x-app-layout>
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="flex items-center gap-4 mb-6">
            ...
            <div>
                <h1 class="text-2xl font-bold text-gray-900 tracking-tight">Record Expense</h1>
                <p class="text-sm text-gray-500 mt-1">Add a new financial outgoing record to your book</p>
            </div>
        </div>

        <!-- Form Card -->
        <form class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden" action="{{ route('expenses.index') }}" method="GET">
                ...
                <div class="grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-6">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" step="0.01" name="amount" id="amount" class="block w-full pl-10 pr-4 py-3 text-lg font-bold border border-gray-200 rounded-xl focus:ring-[#0c6d57] focus:border-[#0c6d57]" placeholder="0.00" required>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="date" name="date" id="date" value="{{ date('Y-m-d') }}" class="block w-full py-2.5 px-3 border border-gray-200 rounded-xl focus:ring-[#0c6d57] focus:border-[#0c6d57] sm:text-sm" required>
                    </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <p class="mt-1.5 text-xs text-gray-500">Link this expense directly to a specific batch for precise profit calculation.</p>
                    </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea id="description" name="description" rows="3" class="block w-full py-2.5 px-3 border border-gray-200 rounded-xl focus:ring-[#0c6d57] focus:border-[#0c6d57] sm:text-sm resize-none" placeholder="e.g., 3 Sacks of Grower Feeds from Agri-Vert" required></textarea>
                    </div>
                    ...
                    <div class="sm:col-span-2" x-data="{ fileName: null }">
                        ...
                        <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-xl hover:bg-gray-50 transition-colors relative cursor-pointer" :class="fileName ? 'bg-[#0c6d57]/5 border-[#0c6d57]/30' : ''">
                            <div class="space-y-1 text-center flex flex-col items-center">
                                ...
                                <p class="text-xs text-gray-500" x-show="!fileName">PNG, JPG up to 10MB</p>
            ...
            <div class="px-6 py-4 bg-gray-50 border-t border-gray-100 flex flex-col-reverse sm:flex-row sm:justify-end gap-3">
                <a href="{{ route('expenses.index') }}" class="w-full sm:w-auto inline-flex justify-center items-center px-5 py-2.5 border border-gray-300 shadow-sm text-sm font-bold rounded-xl text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#0c6d57] transition-colors">
                    Cancel
                </a>
