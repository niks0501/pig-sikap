    ...
    <div
        ...
        data-props="{{ json_encode([
            'resolution' => [
                ...
                'focal_person_name' => $resolution->focal_person_name,
            ...
            'meeting' => $resolution->meeting ? [
                ...
                'meeting_type' => $resolution->meeting->meeting_type ?? 'pig_production',
                'present_count' => $resolution->meeting->present_count,
                'agenda_json' => $resolution->meeting->agenda_json,
            ] : null,
            ...
            'withdrawals' => $resolution->withdrawals->map(fn ($w) => [
                ...
                'evidence_file_url' => $w->evidenceFileUrl(),
                'liquidation_status' => $w->liquidationReport?->liquidation_status,
                'liquidation_status_label' => $w->liquidationReport?->liquidation_status_label,
                'notes' => $w->notes,
            ])->values(),
            ...
            'routes' => [
                ...
                'liquidationStatusUpdate' => 'workflow.withdrawals.report.status',
            ],
