...
<body>
    <div class="header">
        <div class="badge">MONTHLY FINANCIAL REPORT</div>
    ...
    @if (!empty($chartImages['monthlyNet'] ?? null))
        <div style="margin-top: 20px; page-break-inside: avoid;">
            <div style="font-size: 13px; font-weight: bold; color: #0c6d57; margin-bottom: 8px;">Monthly Financial Summary</div>
            <img src="{{ $chartImages['monthlyNet'] }}" style="max-width: 100%;">
        </div>
    @endif
