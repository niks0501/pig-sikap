...
<body>
    ...
    <div class="meta">
        ...
        <span>Category:</span> {{ $filters['category'] ?? 'All' }} &nbsp;&bull;&nbsp;
    ...
    <table>
        ...
        <tbody>
            ...
            <tr class="total-row">
                ...
                <td colspan="2">{{ $summary['entry_count'] ?? 0 }} entries</td>
            </tr>
        </tbody>
    </table>

    @if (!empty($chartImages['expensePie'] ?? null))
        <div style="margin-top: 20px; page-break-inside: avoid;">
            <div style="font-size: 13px; font-weight: bold; color: #0c6d57; margin-bottom: 8px;">Expense Breakdown</div>
            <img src="{{ $chartImages['expensePie'] }}" style="max-width: 100%;">
        </div>
    @endif
